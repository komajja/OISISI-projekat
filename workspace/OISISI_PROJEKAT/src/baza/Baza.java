...
public class Baza{
	public static ArrayList<Adress> adresses = new ArrayList<Adress>();
	...
	public static ArrayList<Software> software = new ArrayList<Software>();
	...
	static Render render_a = new Render(1, new ArrayList<String>(List.of("voda", "zemlja", "zlato")), 
			new ArrayList<String>(List.of("cam1")),  "Ambijentalno",
	...
	static Render render_b = new Render(2, new ArrayList<String>(List.of("plastika", "metal", "pesak")), 
			new ArrayList<String>(List.of("cam2")),  "Difuzno",
	...
	//da moze da se poziva iz bilo koje klase kasnije
	public static ArrayList<Adress> getAdress() {
        return adresses;
    }
    
    public static ArrayList<Brush> getBrush() {
        return brushes;
    }
    
    public static ArrayList<Render> getRender() {
        return renders;
    }
