...
public class BazaSoftware {
	...
	static Software software_b= new Software(2, "Zbrush", new ArrayList<Brush>(List.of(BazaCetkica.brush_a,BazaCetkica.brush_b, BazaCetkica.brush_c)), new ArrayList<String>(List.of("Extrude")), ".obj", new ArrayList<String>(List.of("animationTool")), new ArrayList<Render>(List.of(BazaRenderi.render_b)));
	static Software software_c= new Software(3, "Blender", new ArrayList<Brush>(List.of(BazaCetkica.brush_c)), new ArrayList<String>(List.of("Bevel")), ".fbx", new ArrayList<String>(List.of("animationTool")), new ArrayList<Render>(List.of(BazaRenderi.render_a)));
	static Software software_d= new Software(4, "asd", new ArrayList<Brush>(List.of(BazaCetkica.brush_a, BazaCetkica.brush_b)), new ArrayList<String>(List.of("Noise")),".max", new ArrayList<String>(List.of("bone tool, curve graph")), new ArrayList<Render>(List.of(BazaRenderi.render_b)));
	static Software software_e= new Software(5, "gfdh", new ArrayList<Brush>(List.of(BazaCetkica.brush_a, BazaCetkica.brush_b)), new ArrayList<String>(List.of("Noise")),".max", new ArrayList<String>(List.of("bone tool, curve graph")), new ArrayList<Render>(List.of(BazaRenderi.render_a)));
	static Software software_f= new Software(6, "gdfds", new ArrayList<Brush>(List.of(BazaCetkica.brush_a, BazaCetkica.brush_b)), new ArrayList<String>(List.of("Noise")),".max", new ArrayList<String>(List.of("bone tool, curve graph")), new ArrayList<Render>(List.of(BazaRenderi.render_a)));
